...
export class Sorcerer {
  static itensSorcerer(): Item[] {
    ...
    itens.push(new Item(id++, "Soulful Legs", "https://www.tibiawiki.com.br/images/d/d4/Soulful_Legs.gif", vocacao, SlotEnum.Legs, 0, true, [new Protecao(ProtecaoEnum.Holy, 8)], 0));
    itens.push(new Item(id++, "Gill Legs", "https://www.tibiawiki.com.br/images/a/a6/Gill_Legs.gif", vocacao, SlotEnum.Legs, 0, true, [new Protecao(ProtecaoEnum.Earth, 8), new Protecao(ProtecaoEnum.Fire, -8)], 0));
    ...
    itens.push(new Item(id++, "Dwarven Legs", "https://www.tibiawiki.com.br/images/3/34/Dwarven_Legs.gif", vocacao, SlotEnum.Legs, 0, true, [new Protecao(ProtecaoEnum.Physical, 3)], 0));
