...
export class Sorcerer {
  static itensSorcerer(): Item[] {
    ...
    // Helmets
    itens.push(new Item(id++, "Arcanomancer Regalia", "https://www.tibiawiki.com.br/images/b/b1/Arcanomancer_Regalia.gif", vocacao, SlotEnum.Helmet, 0, true, [new Protecao(ProtecaoEnum.Physical, 3), new Protecao(ProtecaoEnum.Earth, 7)], 0));
    itens.push(new Item(id++, "Falcon Circlet", "https://www.tibiawiki.com.br/images/6/65/Falcon_Circlet.gif", vocacao, SlotEnum.Helmet, 0, true, [new Protecao(ProtecaoEnum.Fire, 9)], 0));
    ...
    itens.push(new Item(id++, "Galea Mortis", "https://www.tibiawiki.com.br/images/3/34/Galea_Mortis.gif", vocacao, SlotEnum.Helmet, 0, true, [new Protecao(ProtecaoEnum.Death, 6), new Protecao(ProtecaoEnum.Holy, -3)], 0));
    itens.push(new Item(id++, "Gnome Helmet", "https://www.tibiawiki.com.br/images/9/97/Gnome_Helmet.gif", vocacao, SlotEnum.Helmet, 0, true, [new Protecao(ProtecaoEnum.Physical, 3), new Protecao(ProtecaoEnum.Energy, 8), new Protecao(ProtecaoEnum.Ice, -2)], 0));

    // Armors
    itens.push(new Item(id++, "Soulmantle", "https://www.tibiawiki.com.br/images/c/cb/Soulmantle.gif", vocacao, SlotEnum.Armor, 0, true, [new Protecao(ProtecaoEnum.Physical, 4)], 1, Item.allImbuiments()));
    itens.push(new Item(id++, "Elven Mail", "https://www.tibiawiki.com.br/images/0/01/Elven_Mail.gif", vocacao, SlotEnum.Armor, 0, true, [], 2, Item.allImbuiments()));
    itens.push(new Item(id++, "Dawnfire Sherwani", "https://www.tibiawiki.com.br/images/5/5d/Dawnfire_Sherwani.gif", vocacao, SlotEnum.Armor, 0, true, [new Protecao(ProtecaoEnum.Fire, 4), new Protecao(ProtecaoEnum.Earth, -2)], 0));
    itens.push(new Item(id++, "Toga Mortis", "https://www.tibiawiki.com.br/images/4/4a/Toga_Mortis.gif", vocacao, SlotEnum.Armor, 0, true, [new Protecao(ProtecaoEnum.Death, 6)], 0));
    itens.push(new Item(id++, "Dream Shroud", "https://www.tibiawiki.com.br/images/a/ad/Dream_Shroud.gif", vocacao, SlotEnum.Armor, 0, true, [new Protecao(ProtecaoEnum.Energy, 10)], 0));
    itens.push(new Item(id++, "Living Armor", "https://www.tibiawiki.com.br/images/c/c4/Living_Armor.gif", vocacao, SlotEnum.Armor, 0, true, [new Protecao(ProtecaoEnum.Earth, 12), new Protecao(ProtecaoEnum.Fire, -5)], 0));

    // Legs
    itens.push(new Item(id++, "Soulshanks", "https://www.tibiawiki.com.br/images/d/d2/Soulshanks.gif", vocacao, SlotEnum.Legs, 0, true, [new Protecao(ProtecaoEnum.Death, 10)], 0));
    ...
    itens.push(new Item(id++, "Pair of Dreamwalkers", "https://www.tibiawiki.com.br/images/5/53/Pair_of_Dreamwalkers.gif", vocacao, SlotEnum.Boots, 0, true, [new Protecao(ProtecaoEnum.Earth, 8)], 0));
    ...
    itens.push(new Item(id++, "Pair of Nightmare Boots", "https://www.tibiawiki.com.br/images/e/ec/Pair_of_Nightmare_Boots.gif", vocacao, SlotEnum.Boots, 0, true, [new Protecao(ProtecaoEnum.Energy, 6)], 0));
    itens.push(new Item(id++, "Void Boots", "https://www.tibiawiki.com.br/images/f/f7/Void_Boots.gif", vocacao, SlotEnum.Boots, 0, true, [new Protecao(ProtecaoEnum.Energy, 10)], 0));

    // Spellbooks
    itens.push(new Item(id++, "Arcanomancer Folio", "https://www.tibiawiki.com.br/images/5/5b/Arcanomancer_Folio.gif", vocacao, SlotEnum.ShieldOrSpellbookOrQuiver, 0, true, [new Protecao(ProtecaoEnum.Physical, 3), new Protecao(ProtecaoEnum.Fire, 8)], 1, [ImbuimentProtecaoEnum.Death, ImbuimentProtecaoEnum.Earth, ImbuimentProtecaoEnum.Energy, ImbuimentProtecaoEnum.Holy, ImbuimentProtecaoEnum.Ice]));
    ...
    itens.push(new Item(id++, "Lion Spellbook", "https://www.tibiawiki.com.br/images/e/eb/Lion_Spellbook.gif", vocacao, SlotEnum.ShieldOrSpellbookOrQuiver, 0, true, [new Protecao(ProtecaoEnum.Physical, 3), new Protecao(ProtecaoEnum.Ice, 7)], 1, [ImbuimentProtecaoEnum.Death, ImbuimentProtecaoEnum.Earth, ImbuimentProtecaoEnum.Energy, ImbuimentProtecaoEnum.Fire, ImbuimentProtecaoEnum.Holy]));
    ...
    itens.push(new Item(id++, "Shoulder Plate", "https://www.tibiawiki.com.br/images/3/32/Shoulder_Plate.gif", vocacao, SlotEnum.ShieldOrSpellbookOrQuiver, 0, true, [new Protecao(ProtecaoEnum.Physical, 3), new Protecao(ProtecaoEnum.Earth, 6)], 1, [ImbuimentProtecaoEnum.Death, ImbuimentProtecaoEnum.Energy, ImbuimentProtecaoEnum.Fire, ImbuimentProtecaoEnum.Holy, ImbuimentProtecaoEnum.Ice]));
    itens.push(new Item(id++, "Spirit Guide", "https://www.tibiawiki.com.br/images/4/42/Spirit_Guide.gif", vocacao, SlotEnum.ShieldOrSpellbookOrQuiver, 0, true, [new Protecao(ProtecaoEnum.Energy, 6)], 1, [ImbuimentProtecaoEnum.Death, ImbuimentProtecaoEnum.Earth, ImbuimentProtecaoEnum.Fire, ImbuimentProtecaoEnum.Holy, ImbuimentProtecaoEnum.Ice]));
    ...
    itens.push(new Item(id++, "Wooden Spellbook", "https://www.tibiawiki.com.br/images/0/07/Wooden_Spellbook.gif", vocacao, SlotEnum.ShieldOrSpellbookOrQuiver, 0, true, [new Protecao(ProtecaoEnum.Earth, 5)], 1, [ImbuimentProtecaoEnum.Death, ImbuimentProtecaoEnum.Energy, ImbuimentProtecaoEnum.Fire, ImbuimentProtecaoEnum.Holy, ImbuimentProtecaoEnum.Ice]));
    ...
    // Amulets
    itens.push(new Item(id++, "Enchanted Theurgic Amulet", "https://www.tibiawiki.com.br/images/8/8d/Enchanted_Theurgic_Amulet.gif", vocacao, SlotEnum.Amulet, 0, true, [new Protecao(ProtecaoEnum.Physical, 3), new Protecao(ProtecaoEnum.Earth, 14)], 0));
    ...
    // Rings
    itens.push(new Item(id++, "Charged Arcanomancer Sigil", "https://www.tibiawiki.com.br/images/7/77/Charged_Arcanomancer_Sigil.gif", vocacao, SlotEnum.Ring, 0, true, [new Protecao(ProtecaoEnum.Fire, 4), new Protecao(ProtecaoEnum.Earth, 4), new Protecao(ProtecaoEnum.Energy, 4), new Protecao(ProtecaoEnum.Ice, 4)], 0));
    ...
    // Extra Slots
    itens.push(new Item(id++, "Sun Catcher", "https://www.tibiawiki.com.br/images/d/da/Sun_Catcher.gif", vocacao, SlotEnum.ExtraSlot, 0, true, [new Protecao(ProtecaoEnum.Fire, 5)], 0));
    itens.push(new Item(id++, "Moon Mirror", "https://www.tibiawiki.com.br/images/4/46/Moon_Mirror.gif", vocacao, SlotEnum.ExtraSlot, 0, true, [new Protecao(ProtecaoEnum.Death, 5)], 0));
    itens.push(new Item(id++, "Starlight Vial", "https://www.tibiawiki.com.br/images/d/da/Sun_Catcher.gif", vocacao, SlotEnum.ExtraSlot, 0, true, [new Protecao(ProtecaoEnum.ManaDrain, 5)], 0));
    itens.push(new Item(id++, "Lit Torch", "https://www.tibiawiki.com.br/images/3/3a/Lit_Torch.gif", vocacao, SlotEnum.ExtraSlot, 0, true, [new Protecao(ProtecaoEnum.Holy, 2)], 0));
    itens.push(new Item(id++, "Bone Fiddle", "https://www.tibiawiki.com.br/images/3/3b/Bone_Fiddle.gif", vocacao, SlotEnum.ExtraSlot, 0, true, [new Protecao(ProtecaoEnum.LifeDrain, 5)], 0));
    itens.push(new Item(id++, "Conch Shell Horn", "https://www.tibiawiki.com.br/images/5/5b/Conch_Shell_Horn.gif", vocacao, SlotEnum.ExtraSlot, 0, true, [new Protecao(ProtecaoEnum.Ice, 2)], 0));
    itens.push(new Item(id++, "Scarab Ocarina", "https://www.tibiawiki.com.br/images/b/be/Scarab_Ocarina.gif", vocacao, SlotEnum.ExtraSlot, 0, true, [new Protecao(ProtecaoEnum.Earth, 2)], 0));
